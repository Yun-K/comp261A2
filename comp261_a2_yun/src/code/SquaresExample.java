...
/**
 * This is a small example class to demonstrate extending the GUI class and implementing the
 * abstract methods. Instead of doing anything maps-related, it draws some squares to the
 * drawing area which are removed when clicked. Some information is given in the text area, and
 * pressing any of the navigation buttons makes a new set of squares.
 * 
 * @author tony
 */
public class SquaresExample extends GUI {
    ...
    protected void onClick(MouseEvent e) {
         ...
         * front-to-back) so that we always remove the top square if there are any overlapping.
         * this is why we use a list and not a set to store the squares in the first place.
         */
        int i = squares.size();
        while (i-- > 0) {
    ...
    /**
     * A simple inner class that stores the data for the squares and has some helper methods.
     */
