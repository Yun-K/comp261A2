...
/**
 * This is the Stream version of the Parser.java file. The two files are essentially the same,
 * so feel free to use either of them. This file is an alternative of Parser.java. It
 * implements the methods using the Stream functionality. It is faster, and help you learn a
 * bit of recent and fancy Java functionalities.
 */
public class Parser_Stream {

    private Parser_Stream() {
        // empty private constructor
    }

    private static final Function<String, String[]> splitByTab = line -> line.split("[\t]+");
    ...
    public static Map<Integer, Node> parseNodes(
        ...
        try {
            ...
            final Function<String[], Node> nodeFrom = tokens -> {
    ...
    public static Map<Integer, Road> parseRoads(
        ...
        try {
            ...
            final Function<String[], Road> toRoad = tokens -> {
    ...
    public static Collection<Segment> parseSegments(
            ...
            Graph graph) {
        try {
            final Function<String[], Segment> toSegment = tokens -> {
                int roadID = asInt(tokens[0]);
    ...
    private static double[] asDouble(String[] tokens, int skip) {
        if (skip < 0)
            skip = 0;
        return Stream.of(tokens)
                .skip(skip) // skip to read the coordinates
                .mapToDouble(Parser_Stream::asDouble)
                .toArray();
    }
}
