...
/**
 * This is an implementation of a trie, used for the search box. We cheat a bit and store
 * references to the actual Road objects in each node, blowing the memory efficiency but making
...
public class Trie {
    ...
    /**
     * Performs a traversal of the Trie rooted at the given TrieNode, accumulating all the
     * Roads into a provided Collection.
     */
    ...
    /**
     * Represents a single node in the trie. It contains a collection of the Roads whose names
     * are exactly the traversal down to this node.
     */
